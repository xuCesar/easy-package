...
export const mockScan: EnvironmentScan = {
  ...
  pathObservations: [
    { command: "node", activePath: "/opt/homebrew/bin/node", alternatives: ["~/.nvm/versions/node/v22.17.1/bin/node"], hasConflict: true, candidates: [{ path: "/opt/homebrew/bin/node", pathIndex: 0, managerId: "homebrew" }, { path: "~/.nvm/versions/node/v22.17.1/bin/node", pathIndex: 1 }] },
    { command: "python", activePath: "/opt/homebrew/bin/python3", alternatives: ["/usr/bin/python3"], hasConflict: true, candidates: [{ path: "/opt/homebrew/bin/python3", pathIndex: 0, managerId: "homebrew" }, { path: "/usr/bin/python3", pathIndex: 1 }] },
    { command: "npm", activePath: "/opt/homebrew/bin/npm", alternatives: [], hasConflict: false, candidates: [{ path: "/opt/homebrew/bin/npm", pathIndex: 0, managerId: "npm", version: "11.5.1" }] },
    { command: "pip", activePath: "/opt/homebrew/bin/pip3", alternatives: ["/usr/bin/pip3"], hasConflict: true, candidates: [{ path: "/opt/homebrew/bin/pip3", pathIndex: 0, managerId: "pip" }, { path: "/usr/bin/pip3", pathIndex: 1 }] },
  ],
  scannedAt: now,
  partialFailures: 0,
};
